...
namespace Auto
{
    public static class Constants
    {
        ...
        public static readonly List<ushort> ModifierKeys = new List<ushort> { 16, 17, 18, 91, 92, 160, 161, 162, 163, 164, 165 };
        ...
        public static readonly Dictionary<string, Keys> KeyMap = new Dictionary<string, Keys>
        {
            {"Backspace",Keys.Back},
            {"Tab",Keys.Tab},
            {"Return",Keys.Return},
